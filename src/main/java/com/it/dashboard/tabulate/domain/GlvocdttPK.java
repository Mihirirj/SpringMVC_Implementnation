...
/**
 * The primary key class for the GLVOCDTT database table.
 * 
 */
@Embeddable
public class GlvocdttPK implements Serializable {
	//default serial version id, required for serializable classes.
	private static final long serialVersionUID = 1L;

	@Column(name="SEQ_NO", unique=true, nullable=false, precision=4)
	private long seqNo;
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof GlvocdttPK)) {
			return false;
		}
		GlvocdttPK castOther = (GlvocdttPK)other;
		return 

...
<head>
  ...
  <title>
    Management Portal - New Connection
  </title>
  <!--     Fonts and icons     -->
...
<script type="text/javascript" src="<c:url value="/resources/js/jquery-3.1.0.min.js"/>"></script>
	...
	<script>
	function viewBottomList(areaCode) {
		//alert('viewBottomList'+areaCode);
	    $.ajax({
	    	type: "GET",
	    	
	        url : 'viewBottomDetailList?id='+areaCode,
	        data: $("#smcForm").serialize(),
	        success : function(data) {
	            $('#bottomList').html(data);
	        }
	    });
	    e.preventDefault();
	...
	function pageLoad(){
		alert('onload');
		var element = document.getElementById('bottomList');
		alert('onload'+element);
...
<body onload="pageLoad()" class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <!-- End Navbar -->
    <form:form name="smcForm" id="smcForm" method="post" action="pendingEstimate"  >
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><a href="javascript:viewBottomList('${row.code}')">${row.code}</a></h6>
                            
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">${row.count1}</p>

        		...
        		<tr>
        			<td width="40%" valign="top">
        				...
        				<fieldset>
        					...
        					<c:if test="${myVar !='NEW'}">
	        					<p>
		        					<form:label cssClass="field" path="pivDetail.id.pivNo">PIV No. (to be setoff) : </form:label>
		        					<form:input  id="txtRefNo" path="pivDetail.id.pivNo" size="30" maxlength="24" />
	        				...
	        				<p>
									<form:label cssClass="field" path="pivDetail.setoffFrom">PIV No. (Setoff From) : </form:label>
									<form:input id="Iintsim1" path="pivDetail.setoffFrom" readonly="" />
								</p>
        					<p>
        			...
        			<td width="60%" valign="top">
	        			...
	        			<fieldset>
							...
							<div id="branchTbl"	>
								<%@ include file="../issue/agentBranchCombo.jsp" %>
							</div>
							<div id="payList"><%@ include file="../issue/payments.jsp" %></div>
